...
<body class="bg-gray-100 min-h-screen flex items-center justify-center">
    <div class="max-w-md w-full space-y-8">
        ...
        <form class="mt-8 space-y-6 bg-white p-8 rounded-lg shadow-md" method="POST" action="{{ route('admin.password.update') }}">
            @csrf
            ...
            <div>
                ...
                <input id="email" name="email" type="email" required 
                       ...
                       value="{{ old('email', $email) }}" placeholder="admin@example.com">
                @error('email')
