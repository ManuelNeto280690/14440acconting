...
<head>
    ...
    <title>{{ config('app.name', 'Laravel') }} - {{ tenant('name') ?? 'Tenant' }} @yield('title', 'Dashboard')</title>
        ...
        <div id="sidebar" class="w-64 gradient-primary shadow-2xl transition-all duration-300 ease-in-out">
            ...
            <div class="flex items-center justify-center h-20 border-b border-white/20">
                <div class="flex items-center space-x-3">
                    ...
                    <h1 class="text-white text-xl font-bold">{{ tenant('name') ?? 'Tenant Panel' }}</h1>
                </div>
            </div>
            ...
            <nav class="mt-8 px-4">
                <div class="space-y-2">
                    ...
                    <a href="{{ route('tenant.clients.index') }}" 
                       class="sidebar-link {{ request()->routeIs('tenant.clients.*') ? 'active' : '' }}">
                    ...
                    <a href="{{ route('tenant.documents.index') }}" 
                       class="sidebar-link {{ request()->routeIs('tenant.documents.*') ? 'active' : '' }}">
                    ...
                    <a href="{{ route('tenant.invoices.index') }}" 
                       class="sidebar-link {{ request()->routeIs('tenant.invoices.*') ? 'active' : '' }}">
                        <i class="fas fa-file-invoice-dollar w-5 text-center mr-3"></i>
                        <span>Invoices</span>
                    </a>

                    <!-- Messages -->
                    <a href="{{ route('tenant.chat.conversation') }}" 
                       class="sidebar-link {{ request()->routeIs('tenant.chat.conversation', 'tenant.messages.*') ? 'active' : '' }}">
                        <i class="fas fa-comments w-5 text-center mr-3"></i>
                        <span>Chat</span>
                        @php
                            $unreadCount = \App\Models\ChatMessage::where('status', 'pending')
                    ...
                    <!-- AI Chat -->
                    <a href="{{ route('tenant.chat.ai') }}" 
                       class="sidebar-link {{ request()->routeIs('tenant.chat.ai') ? 'active' : '' }}">
                        <i class="fas fa-robot w-5 text-center mr-3"></i>
                        <span>AI Assistant</span>
                        <span class="ml-auto bg-gradient-to-r from-purple-500 to-pink-500 text-white text-xs rounded-full px-2 py-1">
                            AI
                        </span>
                    </a>
                    ...
                    <div class="px-3 py-2">
                        <p class="text-xs font-semibold text-white/50 uppercase tracking-wider">Settings</p>
                    </div>

                    <!-- Integrations -->
                    <a href="{{ route('tenant.integrations.index') }}" 
                       class="sidebar-link {{ request()->routeIs('tenant.integrations.*') ? 'active' : '' }}">
                        <i class="fas fa-plug w-5 text-center mr-3"></i>
                    ...
                    <a href="{{ route('tenant.profile.show') }}" 
                       class="sidebar-link {{ request()->routeIs('tenant.profile.*') ? 'active' : '' }}">
                ...
                <div class="flex items-center justify-between px-6 py-4">
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-600">Welcome back, {{ Auth::guard('tenant')->user()->name ?? 'User' }}</p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center space-x-4">
                                ...
                                <div class="max-h-64 overflow-y-auto">
                                    <a href="#" class="block px-4 py-3 hover:bg-gray-50 transition-colors">
                                        <div class="flex items-start space-x-3">
                                            ...
                                            <div>
                                                <p class="text-sm font-medium text-gray-800">New document processed</p>
                                    ...
                                    <a href="#" class="block px-4 py-3 hover:bg-gray-50 transition-colors">
                                        <div class="flex items-start space-x-3">
                                            ...
                                            <div>
                                                <p class="text-sm font-medium text-gray-800">Invoice payment received</p>
                        ...
                        <div class="relative" x-data="{ open: false }">
                            <button @click="open = !open" 
                                ...
                                <span class="absolute -top-1 -right-1 bg-red-500 text-white text-xs rounded-full h-5 w-5 flex items-center justify-center">7</span>
                            </button>
                                ...
                                <div class="max-h-64 overflow-y-auto">
                                    <a href="#" class="block px-4 py-3 hover:bg-gray-50 transition-colors">
                                        <div class="flex items-start space-x-3">
                                            ...
                                            <div>
                                                <p class="text-sm font-medium text-gray-800">New client message</p>
                        ...
                        <div class="relative" x-data="{ open: false }">
                            <button @click="open = !open" 
                                ...
                                <div class="hidden md:block text-left">
                                    ...
                                    <p class="text-xs text-gray-500">{{ tenant('name') ?? 'Tenant' }}</p>
                                </div>
                            ...
                            <div x-show="open" @click.away="open = false" 
                                ...
                                <a href="{{ route('tenant.profile.show') }}" class="flex items-center px-4 py-3 text-sm text-gray-700 hover:bg-gray-50 transition-colors">
                                    <i class="fas fa-user w-4 mr-3 text-gray-400"></i>
                                    Profile
                                </a>
                                <a href="{{ route('tenant.billing.index') }}" class="flex items-center px-4 py-3 text-sm text-gray-700 hover:bg-gray-50 transition-colors">
                ...
                <div class="mx-6 mt-4">
                    <div class="bg-red-50 border border-red-200 text-red-700 px-4 py-3 rounded-xl shadow-sm" role="alert">
                        <div class="flex items-start">
                            ...
                            <div>
                                <p class="font-medium">There are some errors in your submission:</p>
